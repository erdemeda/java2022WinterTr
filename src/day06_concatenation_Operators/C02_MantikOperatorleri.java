...
public class C02_MantikOperatorleri {
    public static void main(String[] args) {
        ...
        int sayi3=15;
        //sayi3ün 10 ile 20 araliginda oldugnu true diyerek döndürelim
        //Java 3lü karsilastirma kabul etmez
        //ikili karsilastirmalar yapip mantiksal operatorlerle birlestirmeliyiz

        System.out.println(10<sayi3&& sayi3<20);//true

        int sayi4=5;
        //sayi4ün 10 ile 20 arasinda olmadiğini true diyerek dondurelim
