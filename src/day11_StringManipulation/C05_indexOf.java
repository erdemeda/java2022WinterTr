...
public class C05_indexOf {
    public static void main(String[] args) {
        ...
        System.out.println(str1.indexOf("b"));//5  bulduguilk dogru eslesmenin indexini dondurur
        ...
        int ilkindex=str1.indexOf('a');//1(bunu yazdırmadık)
        System.out.println(str1.indexOf('a',ilkindex+1));//3


        // verilen String'deki 2.b harfinin index'ini bulalim

        int ilkbindex=str1.indexOf('a');//5 (bunu yazdırmadık)

        System.out.println(str1.indexOf('a',ilkbindex+1));//9
