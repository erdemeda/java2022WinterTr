...
public class C02_Varargs {
    ...
    public static void main(String[] args) {
        ...
        //parametre olarak bir int ve istedigimiz kadar string alan en
        //uzun kelimenin harf sayisi ile int parametre degerini carpip
    ...
    private static void carpim(int sayi, String... str) {
        ...
        System.out.println("İstenen deger : "+sayi*enUzunStr.length());
