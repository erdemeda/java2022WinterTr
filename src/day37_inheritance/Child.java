...
public class Child extends Parent {
    ...
    //bir class'i child class yaptigimizda parent class'daki constructur'a
    // ulasmasi gerekir. Bu durumda parent class'daki costructur'in
    ...
    Child (int s){
        //Child class'da tum constructor'larin
        // ilk satirina Java'nin yerlestirdigi constructor
    ...
    Child(int sayi1, int sayi2){
        ...
        // baska bir constructor'i calistirmak isterseniz bunu Child
        // class'daki constructor'in ILK SATIRINA yazmalisiniz
        super(sayi1,sayi2);
